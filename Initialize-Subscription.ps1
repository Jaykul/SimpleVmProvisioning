...
param(
    ...
    [string]$resourceGroupName = "EncryptionSpike",
    ...
    # [Parameter(Mandatory)]
    [ValidateNotNullOrEmpty()]
    [string]$keyVaultName = "EncryptionSpike",
    ...
    # [Parameter(Mandatory)]
    [ValidateNotNullOrEmpty()]
    [string]$subscriptionId = "55f2c7c6-a8f9-4d38-9833-f331007e9b74",

    # Name of the AAD application that will be used to write secrets to KeyVault. A new application with this name will be created if one doesn't exist. If this app already exists, pass aadClientSecret parameter to the script
    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string]$aadAppName = "EncryptionSpike",

    # Client secret of the AAD application that was created earlier
    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string]$aadClientSecret = "o65AypYUfNCulbo8",
